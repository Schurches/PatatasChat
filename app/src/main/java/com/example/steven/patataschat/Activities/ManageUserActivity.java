...
public class ManageUserActivity extends AppCompatActivity {
    ...
    public void establishAvailableOptions(){
        ...
        if(rank == 3){
            ...
            this.rankButton.setEnabled(false);
        }else if(rank < 3){
            this.nickButton.setEnabled(false);
        ...
        switch (current_action){
            ...
            case ACTION_BAN:
                if(current_selected == -1){
                    ...
                    String message = String.format(getResources().getString(R.string.manage_confirm_ban),name);
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                for(int i = 0; i < size; i++){
                    if(users_list.get(i).getUser_id().equals(user.getUser_id())){
                        ...
                        if(current_selected == i && current_action == ACTION_NICKNAME){
                            loadUserInfo(i);
                        }
                    }
                }
